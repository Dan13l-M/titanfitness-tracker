...
import { CompletedWorkout, BodyMetric, Exercise } from '../types';
...
const Dashboard: React.FC<DashboardProps> = ({ userName, history, metrics, exercises, onAddMetric, onDeleteMetric, onDeleteWorkout, unit, onUnitChange }) => {
          ...
          <div className="card p-5 rounded-2xl">
            ...
            <div className="space-y-3">
              {history.length === 0 ? (
                ...
                <div key={workout.id} className="flex items-center justify-between p-4 bg-[var(--color-bg)] rounded-xl border border-[var(--color-border)] hover:border-[var(--color-border-hover)] transition-all group">
